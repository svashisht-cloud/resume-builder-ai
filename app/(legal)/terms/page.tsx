...
export const metadata: Metadata = {
  ...
  description: 'Terms of Service for Forte Resume - the AI resume tailoring app.',
}
    ...
    <div className="mx-auto max-w-3xl">
      <article className="text-sm leading-7">
        ...
        <div className="mb-8 space-y-1">
          ...
          <p className="text-text-dim">Last updated: April 24, 2026</p>
        </div>
        ...
        <div className="border-t border-border">
          <Section title="Agreement to Our Legal Terms">
            <p className="text-muted">
              We are Forte, doing business as Forte Resume (&ldquo;Company,&rdquo; &ldquo;we,&rdquo;{' '}
              &ldquo;us,&rdquo; &ldquo;our&rdquo;), a company registered in India at D-2/64,
              Janakpuri, New Delhi, Delhi 110058.
            </p>
            <p className="text-muted">
              We operate the website{' '}
              <a
                href="https://www.forteresume.com/"
                className="underline underline-offset-2 transition-colors hover:text-foreground"
                target="_blank"
                rel="noopener noreferrer"
              >
                https://www.forteresume.com/
              </a>{' '}
              (the &ldquo;Site&rdquo;), as well as any other related products and services that refer
              or link to these legal terms (the &ldquo;Legal Terms&rdquo;) (collectively, the
              &ldquo;Services&rdquo;).
            </p>
            <p className="text-muted">
              Forte Resume helps job seekers create, tailor, and optimize their resumes using AI to
              match job descriptions and improve their chances of landing interviews.
            </p>
            <p className="text-muted">
              You can contact us by phone at 4134099810, email at{' '}
              <a
                href="mailto:nucaluregamgin@gmail.com"
                className="underline underline-offset-2 transition-colors hover:text-foreground"
              >
                nucaluregamgin@gmail.com
              </a>
              , or by mail to D-2/64, Janakpuri, New Delhi, Delhi 110058, India.
            </p>
            <p className="text-muted">
              These Legal Terms constitute a legally binding agreement made between you, whether
              personally or on behalf of an entity (&ldquo;you&rdquo;), and Forte, concerning your
            ...
            <p className="text-muted">
              ...
              nucaluregaming@gmail.com, as stated in the email message. By continuing to use the
          ...
          <Section title="2. Intellectual Property Rights">
            <p className="font-medium text-muted">Our intellectual property</p>
            <p className="text-muted">
            ...
            <p className="text-muted">
              The Content and Marks are provided in or through the Services &ldquo;AS IS&rdquo; for
              your personal, non-commercial use only.
            </p>
            <p className="font-medium text-muted">Your use of our Services</p>
            <p className="text-muted">
            ...
            <p className="text-muted">solely for your personal, non-commercial use.</p>
            <p className="text-muted">
            ...
            <p className="font-medium text-muted">Your submissions and contributions</p>
            <p className="text-muted">
              Please review this section and the &ldquo;PROHIBITED ACTIVITIES&rdquo; section
            ...
            <p className="text-muted">
              ...
              idea, feedback, or other information about the Services (&ldquo;Submissions&rdquo;),
            ...
            <p className="text-muted">
              ...
              (&ldquo;Contributions&rdquo;). Any Submission that is publicly posted shall also be
            ...
            <ul className="list-disc space-y-1 pl-5 text-muted">
              <li>
                confirm that you have read and agree with our &ldquo;PROHIBITED ACTIVITIES&rdquo;
            ...
            <p className="text-muted">
              ...
              of (a) this section, (b) any third party&rsquo;s intellectual property rights, or (c)
              applicable law.
            </p>
            <p className="text-muted">
              ...
              without notice if in our reasonable opinion we consider such Contributions harmful or
              in breach of these Legal Terms. If we remove or edit any such Contributions, we may
              also suspend or disable your account and report you to the authorities.
            </p>
            <p className="font-medium text-muted">Copyright infringement</p>
            <p className="text-muted">
              We respect the intellectual property rights of others. If you believe that any material
              available on or through the Services infringes upon any copyright you own or control,
              please immediately refer to the &ldquo;COPYRIGHT INFRINGEMENTS&rdquo; section below.
            </p>
          </Section>
          ...
          <Section title="3. User Representations">
            <p className="text-muted">
              ...
              Terms; (4) you are not a minor in the jurisdiction in which you reside; (5) you will
              not access the Services through automated or non-human means, whether through a bot,
          ...
          <Section title="5. Purchases and Payment">
            <p className="text-muted">We accept the following forms of payment:</p>
            <ul className="list-disc space-y-1 pl-5 text-muted">
              <li>Visa</li>
              <li>Mastercard</li>
          ...
          <Section title="6. Subscriptions">
            <p className="font-medium text-muted">Billing and Renewal</p>
            <p className="text-muted">
              ...
              The length of your billing cycle will depend on the type of subscription plan you
              choose when you subscribed to the Services.
            </p>
            <p className="font-medium text-muted">Cancellation</p>
            <p className="text-muted">
            ...
            <p className="font-medium text-muted">Fee Changes</p>
            <p className="text-muted">
          ...
          <Section title="7. Prohibited Activities">
            ...
            <p className="text-muted">As a user of the Services, you agree not to:</p>
            <ul className="list-disc space-y-1.5 pl-5 text-muted">
              ...
              <li>
                ...
                posting of repetitive text), that interferes with any party&rsquo;s uninterrupted
                use and enjoyment of the Services or modifies, impairs, disrupts, alters, or
              ...
              <li>
                ...
                limitation, clear graphics interchange formats (&ldquo;gifs&rdquo;), 1&times;1
              ...
              <li>
                Copy or adapt the Services&rsquo; software, including but not limited to Flash, PHP,
              ...
              <li>
                Use automated tools or bots to scrape, extract, or mass-generate content from the
                platform.
              </li>
              <li>
                Share, resell, or distribute AI-generated resume content for commercial purposes.
              </li>
            </ul>
          </Section>

          <Section title="8. User Generated Contributions">
            <p className="text-muted">
              ...
              personal information or other material (collectively, &ldquo;Contributions&rdquo;).
          ...
          <Section title="9. Contribution License">
            <p className="text-muted">
            ...
            <p className="text-muted">
              ...
              them in more appropriate locations on the Services; and (3) to pre-screen or delete any
              Contributions at any time and for any reason, without notice. We have no obligation to
              monitor your Contributions.
            </p>
          </Section>

          <Section title="10. Social Media">
            <p className="text-muted">
              ...
              &ldquo;Third-Party Account&rdquo;) by either: (1) providing your Third-Party Account
              ...
              of each Third-Party Account. You represent and warrant that you are entitled to
            ...
            <p className="text-muted">
              ...
              and stored in your Third-Party Account (the &ldquo;Social Network Content&rdquo;) so
              that it is available on and through the Services via your account, including without
              limitation any friend lists and (2) we may submit to and receive from your Third-Party
            ...
            <p className="text-muted">
              ...
              for any Social Network Content. You acknowledge and agree that we may access your email
              ...
              you of those contacts who have also registered to use the Services. You can deactivate
              the connection between the Services and your Third-Party Account by contacting us using
          ...
          <Section title="11. Third-Party Websites and Content">
            <p className="text-muted">
              ...
              Content&rdquo;). Such Third-Party Websites and Third-Party Content are not
            ...
            <p className="text-muted">
              ...
              us. If you decide to leave the Services and access the Third-Party Websites or to use
          ...
          <Section title="12. Services Management">
            <p className="text-muted">
          ...
          <Section title="14. Copyright Infringements">
            <p className="text-muted">
              We respect the intellectual property rights of others. If you believe that any material
              available on or through the Services infringes upon any copyright you own or control,
              please immediately notify us using the contact information provided below (a
              &ldquo;Notification&rdquo;). A copy of your Notification will be sent to the person
              ...
              misrepresentations in a Notification. Thus, if you are not sure that material located
              on or linked to by the Services infringes your copyright, you should consider first
          ...
          <Section title="16. Modifications and Interruptions">
            <p className="text-muted">
            ...
            <p className="text-muted">
              ...
              use the Services during any downtime or discontinuance of the Services. Nothing in
          ...
          <Section title="17. Governing Law">
            <p className="text-muted">
              These Legal Terms shall be governed by and defined following the laws of India. Forte
          ...
          <Section title="18. Dispute Resolution">
            <p className="font-medium text-muted">Informal Negotiations</p>
            <p className="text-muted">
              To expedite resolution and control the cost of any dispute, controversy, or claim
              related to these Legal Terms (each a &ldquo;Dispute&rdquo; and collectively, the
            ...
            <p className="font-medium text-muted">Binding Arbitration</p>
            <p className="text-muted">
              ...
              clause. The number of arbitrators shall be one (1). The seat, or legal place, of
              arbitration shall be New Delhi, India. The language of the proceedings shall be
              English. The governing law of these Legal Terms shall be substantive law of India.
            </p>
            <p className="font-medium text-muted">Restrictions</p>
            <p className="text-muted">
          ...
          <Section title="20. Disclaimer">
            <p className="text-muted">
              ...
              REPRESENTATIONS ABOUT THE ACCURACY OR COMPLETENESS OF THE SERVICES&rsquo; CONTENT OR
              THE CONTENT OF ANY WEBSITES OR MOBILE APPLICATIONS LINKED TO THE SERVICES AND WE WILL
              ...
              OR MOBILE APPLICATION FEATURED IN ANY BANNER OR OTHER ADVERTISING, AND WE WILL NOT BE
          ...
          <Section title="21. Limitations of Liability">
            <p className="text-muted">
              ...
              DURING THE SIX (6) MONTH PERIOD PRIOR TO ANY CAUSE OF ACTION ARISING. CERTAIN US STATE
          ...
          <Section title="22. Indemnification">
            <p className="text-muted">
              ...
              (1) your Contributions; (2) use of the Services; (3) breach of these Legal Terms; (4)
              any breach of your representations and warranties set forth in these Legal Terms; (5)
              ...
              the Services with whom you connected via the Services. Notwithstanding the foregoing,
          ...
          <Section title="24. Electronic Communications, Transactions, and Signatures">
            <p className="text-muted">
          ...
          <Section title="25. California Users and Residents">
            <p className="text-muted">
          ...
          <Section title="26. Miscellaneous">
            <p className="text-muted">
          ...
          <Section title="27. Contact Us">
            ...
            <address className="not-italic text-muted">
              <p>Forte</p>
              <p>D-2/64, Janakpuri</p>
              <p>New Delhi, Delhi 110058</p>
              <p>India</p>
              <p>Phone: 4134099810</p>
              <p>
                <a
                  href="mailto:nucaluregamgin@gmail.com"
                  className="underline underline-offset-2 transition-colors hover:text-foreground"
            ...
            <p className="text-xs text-text-dim">
              This Terms and Conditions was created using Termly&rsquo;s Terms and Conditions
              Generator.
            </p>
          </Section>
        </div>
